...
from .picker import CombinedPicker, FormRankPicker, LongshotRankPicker, MidPopularityByLongshotPicker, PopularityPicker
...
#: 精算する買い方の全部（重複の無い名前）。
ALL_PLANS: tuple[TicketPlan, ...] = (*NARROW_PLANS, *WIDE_PLANS, *BASELINE_PLANS)
