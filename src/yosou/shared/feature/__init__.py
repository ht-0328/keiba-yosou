...
| 場所 | 中身 |
|---|---|
| ``feature_catalog.py`` | どの予想でも使う 71個の一覧（``BASE_FEATURES``）と、予想ごとの一覧（``FeatureCatalog``） |
...
from .feature_catalog import BASE_FEATURES, FeatureCatalog
...
__all__ = [
    ...
    "RecentRunSummary", "BASE_FEATURES", "FeatureCatalog", "Feature", "FeatureKind", "FeatureGroup",
