...
| 名前 | 中身 |
|---|---|
| ``RaceConditionSummary`` | A. レースの条件（11個）。レースの1頭目の値と、特別戦か・ハンデ戦か（展開の予想も使うので ``yosou.shared.feature`` に置き、ここでは名前を出し直すだけ） |
...
from yosou.shared.feature import GOING, RaceConditionSummary
